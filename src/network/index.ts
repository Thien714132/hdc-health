...
const getInstance = () => {
  ...
  const createResponseErrorHandler = (axiosInstance: any) => {
    return async (error: any) => LogInterceptor.responseError(error, axiosInstance);
  };
  ...
  // );
  instance.interceptors.request.use(LogInterceptor.requestLog, LogInterceptor.requestError);
...
const post = async (urlApi: string, params: any = null, config?: AxiosRequestConfig) => {
  return networkInstance.instance.post(urlApi, params, config);
};
const patch = async (urlApi: string, params: any = null, config?: AxiosRequestConfig) => {
...
const get = async (urlApi: string, data: any = null, config?: AxiosRequestConfig) => {
  return networkInstance.instance.get(urlApi, { params: data, ...config });
};
const put = async (urlApi: string, params: any = null, config?: AxiosRequestConfig) => {
  return await networkInstance.instance.put(urlApi, params, config);
};

const downloadFile = async (urlApi: string, params: any = null, config?: AxiosRequestConfig) => {
